...
var file_fetch_proto_goTypes = []interface{}{
...
func file_fetch_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_fetch_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fetch_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
